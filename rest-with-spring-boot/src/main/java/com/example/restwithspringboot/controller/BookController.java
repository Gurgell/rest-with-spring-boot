...
public class BookController {
    ...
    @Operation(summary = "Adds a new book", description = "Adds a new book by passing in a JSON or XML representation of the person!",
            tags = {"Book"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = BookVO.class))
    ...
    @Operation(summary = "Updates a book", description = "Updates a book by passing in a JSON or XML representation of the person!",
            tags = {"Book"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = BookVO.class))
    ...
    @Operation(summary = "Deletes a book", description = "Deletes a book by passing in a JSON or XML representation of the person!",
            tags = {"Book"},
            responses = {
                    @ApiResponse(description = "No content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
