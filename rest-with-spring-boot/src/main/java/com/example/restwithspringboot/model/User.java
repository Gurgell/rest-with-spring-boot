...
//    @ManyToMany(fetch = FetchType.EAGER/*Assim que carregar o user também irá carregar as permissões dele utilizando o EAGER*/)
//    @JoinTable(name = "user_permission", //Mapeando a tabela que faz o join do many to many
//            joinColumns = {@JoinColumn (name = "id_user")}, //Mapeando o atributo que faz o join com a coluna atual
//            inverseJoinColumns = {@JoinColumn(name = "id_permission")}) //Mapeando o atributo que faz join com a coluna permission
